...
def MAP(selected_year):
    ...
    fig = px.scatter_mapbox(callback_df,lat = 'latitude', lon = 'longitude',text='description',zoom=1,color_discrete_sequence=["crimson"])
    ...
    fig.update_layout(mapbox_style="open-street-map",hovermode='closest',autosize=True, margin = dict(t=0, b = 0, l = 0, r = 0))
...
app.layout = html.Div(
    style = {'background-image':'url("assets/ufo.jpg")'},
    id="root",
    children=[
        html.Div(
            id="header",
